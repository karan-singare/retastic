...
class Walker_Nav_Primary extends Walker_Nav_Menu {
  ...
  function start_el(&$output, $item, $depth = 0, $args = NULL, $id = 0) { // li a span
      ...
      $classes[] = 'navigation__item menu-item' . $item->ID;
      ...
      $item_output = $args->before; // the default markup
      $item_output .= '<a' . $attributes . '>';
      $item_output .= $args->link_before . apply_filters('nav_title', $item->title, $item->ID) . $args->link_after;
